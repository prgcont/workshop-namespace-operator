...
import (
	...
	"github.com/prgcont/workshop-namespace-operator/pkg/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type OperatorV1alpha1Interface interface {
	RESTClient() rest.Interface
	WorkshopNamespacesGetter
}

// OperatorV1alpha1Client is used to interact with features provided by the operator.prgcont.cz group.
type OperatorV1alpha1Client struct {
	restClient rest.Interface
}

func (c *OperatorV1alpha1Client) WorkshopNamespaces(namespace string) WorkshopNamespaceInterface {
	return newWorkshopNamespaces(c, namespace)
}
